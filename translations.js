...
const translations = {
  en: {
    ...
    messages: {
      ...
      limitedCommands: "Limited commands available now: help, installer.",
      ...
      diggingMessage: "You have dug and gained 5 blocks. (Energy cost: 2)",
      buildNodeSuccess: "You have built a blockchain node! (Cost: 10 energy, 5 blocks)",
      buildRoadSuccess: "You have built a road! (Cost: 3 blocks)",
      ...
      resumeGame: "Resuming your previous game...",
      shutdownMessage: "Shutting down the terminal..."
    }
  },
  fr: {
    commands: {
    ...
    messages: {
      ...
      diggingMessage: "Vous avez creusé et gagné 5 blocs. (Coût : 2 énergie)",
      buildNodeSuccess: "Vous avez bâti un nœud blockchain ! (Coût : 10 énergie, 5 blocs)",
      buildRoadSuccess: "Vous avez construit une route ! (Coût : 3 blocs)",
      ...
      resumeGame: "Reprise de votre partie précédente...",
      shutdownMessage: "Arrêt du terminal..."
    }
  }
};
